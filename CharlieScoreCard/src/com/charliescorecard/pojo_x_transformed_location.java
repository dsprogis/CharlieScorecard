...
public class pojo_x_transformed_location {
	private String _route_id, _trip_id, _trip_name, _stop_id, _stop_sequence, _vehicle_id, _actual_timestamp, _scheduled_timestamp, _time_diff;
	...
	public pojo_x_transformed_location( String route_id, String trip_id, String trip_name, String stop_id, String stop_sequence, String vehicle_id, String actual_timestamp, String scheduled_timestamp, String time_diff ) {
		_route_id = route_id;
		_trip_id = trip_id;
